...
//        beautyToasty.isGravityFullScreen(true);///注意：只针对Gravity.TOP！且必须API 16+！
//        beautyToasty.setGravity(Gravity.TOP | Gravity.RIGHT, 10, 10);
//
//        beautyToasty.show();
...
//        ToastyBase toastyBase = ToastyBase.makeText(this, "ToastyBase!", 3500);
//        toastyBase.show();
...
//        beautyToasty.setAnimationOut(AnimationUtil.NO_ANIMATION);
        ...
        /* -------------------- update -------------------- */
//        mToastyBase.isGravityFullScreen(true);///注意：只针对Gravity.TOP！且必须API 16+！
//        mToastyBase.setGravity(Gravity.TOP | Gravity.RIGHT, 10, 10);
//        mToastyBase.update();
