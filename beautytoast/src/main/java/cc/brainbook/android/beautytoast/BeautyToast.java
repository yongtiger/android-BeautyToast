...
import cc.brainbook.android.beautytoast.view.AnimationLayout;
import cc.brainbook.android.beautytoast.view.StyleLayout;
...
public class BeautyToast {
    ...
    private static int DEFAULT_DURATION = BeautyToast.DURATION_SHORT;
...
//        toast.show();
    ...
    private static void applyStyle(StyleLayout styleLayout, ToastDesc toastDesc) {
        ...
        // text
        if (!BeautyToastUtils.isTrimEmpty(toastDesc.text)) {
            toastTextView.setText(toastDesc.text);
        } else if (toastDesc.textRes != 0) {
            toastTextView.setText(toastDesc.textRes);
        } else {
            throw new IllegalArgumentException("BeautyToast must has one of text or textRes!");
        }
        // textColor
    ...
    public static final class ToastDesc {
        ...
        private int duration = BeautyToast.DEFAULT_DURATION;
        ...
        private boolean showIcon = BeautyToast.SHOW_ICON;

        private boolean animate = BeautyToast.ANIMATE;

        @ColorInt
        private int textColor = BeautyToast.TEXT_COLOR;

        private WeakReference<View> target = null;

        private int textSize = BeautyToast.TEXT_SIZE;

        private int animationGravity = BeautyToast.ANIMATION_GRAVITY;

        private int layoutGravity = BeautyToast.LAYOUT_GRAVITY;

        private int relativeGravity = BeautyToast.RELATIVE_GRAVITY;
        ...
        private boolean sameLength = BeautyToast.SAME_LENGTH;

        private long animationDuration = BeautyToast.ANIMATION_DURATION;

        private int radius = BeautyToast.RADIUS;
        ...
        public ToastDesc duration(int duration) {
            if (duration != BeautyToast.DURATION_SHORT && duration != BeautyToast.DURATION_LONG) {
                throw new IllegalArgumentException("duration should be" +
                        " BeautyToast.DURATION_SHORT or BeautyToast.DURATION_LONG");
            }
    ...
    public static class Config {
        ...
        private int successColor = BeautyToast.SUCCESS_COLOR;

        private int errorColor = BeautyToast.ERROR_COLOR;

        private int infoColor = BeautyToast.INFO_COLOR;

        private int warningColor = BeautyToast.WARNING_COLOR;
        ...
        private int animationDuration = BeautyToast.ANIMATION_DURATION;
        ...
        public Config setDuration(int duration) {
            ...
            if (duration == BeautyToast.DURATION_LONG) {
                this.duration = 1;
            }
            return this;
        }
        ...
        public void apply(Application app) {
            BeautyToast.DURATION_SHORT = shortDurationMillis;
            BeautyToast.DURATION_LONG = longDurationMillis;
            if (this.duration == 0) {
                BeautyToast.DEFAULT_DURATION = BeautyToast.DURATION_SHORT;
            } else {
